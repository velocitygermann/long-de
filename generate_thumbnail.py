...
SCENIC_STYLES = [
    "stunning Dutch woman in traditional dress, Amsterdam, canals",
    "elegant Dutch woman, Rotterdam street, modern architecture, vibrant city",
    "beautiful Dutch woman in traditional dress, Dutch tulip fields",
    "Dutch woman at Rijksmuseum, golden hour, Moorish architecture",
    "gorgeous Dutch woman in modern style, sunset over Amsterdam canals, dramatic sky",
    "beautiful Dutch woman, Seville, Alcázar gardens, warm light",
    "Dutch woman dancing flamenco by Dutch coastline, passionate, zen",
    "elegant Dutch woman in Barcelona, Park Güell, celebration",
]


def generate_scenic_image(category_english: str, category_Dutch: str, output_path: str):
    if False and POLLINATIONS_API_KEY:  # disabled
        for attempt in range(3):
            style = random.choice(SCENIC_STYLES)
            prompt = (
                f"Professional YouTube thumbnail for Dutch language learning video. "
                f"{style}. "
                ...
                f"At top: '120 Dutch PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY Dutch'. Also: '10 MINUTE LESSON' badge."
            )
            try:
    ...
    draw.text((960, 180), "120 Dutch PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
