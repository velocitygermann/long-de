...
SCENIC_STYLES = [
    "stunning German woman in traditional dirndl, Berlin, Brandenburg Gate",
    "elegant German woman, Munich street, Marienplatz, vibrant city",
    "beautiful German woman in traditional dress, Bavaria, alpine village",
    "German woman at Neuschwanstein Castle, golden hour, fairy tale architecture",
    "gorgeous German woman in modern style, sunset over Rhine, dramatic sky",
    "beautiful German woman, Cologne, cathedral gardens, warm light",
    "German woman walking through Black Forest, passionate, zen",
    "elegant German woman in Berlin, Reichstag building, celebration",
]


def generate_scenic_image(category_english: str, category_german: str, output_path: str):
    # Try pre-made thumbnail first
    premade = get_thumbnail("German", category_english)
    if premade:
        return premade
    ...
    de_fonts = ["C:/Windows/Fonts/segoeuib.ttf", "C:/Windows/Fonts/arialbd.ttf",
                "/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf",
    ...
    f_cat = load_font(de_fonts, 90)
    f_sub = load_font(en_fonts, 55)
    f_brand = load_font(en_fonts, 45)

    draw.text((960, 180), "120 GERMAN PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
