...
def generate_scenic_image(category_english: str, category_hindi: str, output_path: str):
    ...
    if premade:
        ...
        for attempt in range(3):
            ...
            prompt = (
                f"Professional YouTube thumbnail for German language learning video. "
                f"{style}. "
                ...
                f"At top: '120 GERMAN PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY GERMAN'. Also: '10 MINUTE LESSON' badge."
            )
            try:
